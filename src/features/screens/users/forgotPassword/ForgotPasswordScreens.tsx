...
const ForgotPasswordScreens: React.FC = ({ navigation }: any) => {
        ...
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
            ...
            >
                ...
                <HStack justifyContent="flex-start" mb={4}>
                    <Text color={colors.text.secondary} fontSize={12}>{t("slogen_forgot_password")} </Text>
                </HStack>
                    ...
                    <Box>
                        <Input size="xl" borderRadius={10} bg={colors.input.background}>
                            ...
                            <InputField
                                ...
                                placeholder={t("login_with_email")}
                                fontSize={14}
                            />
                        </Input>
                    </Box>
